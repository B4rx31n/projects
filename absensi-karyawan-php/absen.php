        ...
        <div class="content">
            ...
            if (!$found) {
                ...
                <div class="result-card error">
                    ...
                    <h3>NAMA Tidak Terdaftar!</h3>
                    <p>NAMA yang Anda masukkan tidak terdaftar dalam sistem.</p>
            ...
            $check = $conn->query("SELECT * FROM absensi WHERE nama='$nama' AND tanggal='$tanggal'");
            if ($check->num_rows > 0) {
                echo '
                <div class="result-card warning">
                    <i class="fas fa-exclamation-triangle"></i>
                    <h3>Sudah Absen Hari Ini!</h3>
                    <p>Anda telah melakukan absensi pada:</p>
                    <div class="info-box">
                ...
                $conn->query("INSERT INTO absensi (nama, tanggal, jam) VALUES ('$nama', '$tanggal', '$jam')");
                echo '
                <div class="result-card success">
                    ...
                    <div class="info-box">
                        <p>Nama: <span>'.$found['nama'].'</span></p>
                        <p>Divisi: <span>'.$found['divisi'].'</span></p>
                        <p>Tanggal: <span>'.$tanggal.'</span></p>
                        <p>Jam: <span>'.$jam.'</span></p>
                    </div>
                    <a href="index.php" class="btn">Kembali ke Beranda</a>
