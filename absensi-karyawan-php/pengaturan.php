        ...
        <div class="topbar">
            <div class="page-title">
                ...
                <div class="breadcrumb">
                    <a href="dashboard.php">Home</a> / <span>Pengaturan</span>
                </div>
            </div>
        </div>
        <div class="settings-container">
            <div class="settings-title"><i class="fas fa-cog"></i> Pengaturan Sistem</div>
            <form method="post" action="">
                <div class="form-group">
                    <label for="app_name">Nama Aplikasi</label>
                    <input type="text" id="app_name" name="app_name" value="Sistem Absensi Karyawan">
                </div>
                <div class="form-group">
                    <label for="jam_masuk">Jam Masuk</label>
                    <input type="time" id="jam_masuk" name="jam_masuk" value="08:00">
                </div>
                <div class="form-group">
