...
<head>
    ...
    <style>
        ...
        th, td {
            padding: 12px 15px; text-align: left; border-bottom: 1px solid #e3e6f0;
        }
        th { background: #f8f9fc; color: #5a5c69; font-weight: 600; }
        tr:last-child td { border-bottom: none; }
        tr:hover { background: #f8f9fc; }
        .btn-export {
            background: #4e73df; color: #fff; border: none; padding: 10px 24px;
            border-radius: 6px; font-size: 16px; cursor: pointer; transition: background 0.2s;
            margin-bottom: 18px;
        }
        .btn-export:hover { background: #2e59d9; }
        .footer {
            text-align: center; padding: 20px; margin-top: 30px; color: #858796; font-size: 14px;
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li><a href="{{ url('/laporan') }}" class="active"><i class="fas fa-chart-bar"></i> <span>Laporan</span></a></li>
            <li><a href="{{ url('/pengaturan') }}"><i class="fas fa-cog"></i> <span>Pengaturan</span></a></li>
            <li>
    ...
    <div class="topbar">
        <div class="page-title">
            ...
            <div class="breadcrumb">
                <a href="{{ url('/dashboard') }}">Home</a> / <span>Laporan</span>
            </div>
        </div>
    </div>
    <div class="content">
