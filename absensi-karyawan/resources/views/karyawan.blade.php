    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="{{ url('/karyawan') }}" class="active"><i class="fas fa-users"></i> <span>Data Karyawan</span></a></li>
        ...
        <div class="topbar">
            <div class="page-title">
                ...
                <div class="breadcrumb">
                    <a href="{{ url('/dashboard') }}">Home</a> / <span>Data Karyawan</span>
                </div>
            </div>
            <div class="user-info">
        ...
        <div class="table-container">
            ...
            <table id="karyawan-table" class="table">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" style="text-align:center;">Tidak ada data karyawan</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    document.getElementById('search-input').addEventListener('input', function () {
        ...
        rows.forEach(row => {
            ...
            if (
                ...
                kelurahan.includes(searchValue)
            ) {
                row.style.display = '';
            } else {
