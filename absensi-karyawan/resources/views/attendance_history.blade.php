    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="{{ url('/absensi') }}" class="active"><i class="fas fa-calendar-check"></i> <span>Absensi</span></a></li>
        ...
        <div class="topbar">
            <div class="page-title">
                ...
                <div class="breadcrumb">
                    <a href="{{ url('/dashboard') }}">Home</a> / <span>Absensi</span>
                </div>
            </div>
        </div>
