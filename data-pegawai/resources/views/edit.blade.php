...
<head>
  ...
  <title>Edit Data Pegawai - SIMPKITA</title>
  ...
  <main class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
      <div class="bg-white rounded-xl shadow-xl overflow-hidden">
        ...
        <form action="{{ route('update', $data->id) }}" method="POST" class="p-6">
          @csrf
          @method('PUT')
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" id="nip" name="nip" value="{{ $data->nip }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" required>
              @error('nip')
            ...
            <div>
              ...
              <input type="text" id="nama" name="nama" value="{{ $data->nama }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" required>
              @error('nama')
                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div>
              ...
              <input type="date" id="tll" name="tll" value="{{ $data->tll }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" required>
              @error('tll')
                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div>
              ...
              <input type="text" id="tamatan" name="tamatan" value="{{ $data->tamatan }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" required>
              @error('tamatan')
                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="md:col-span-2">
              ...
              <textarea id="alamat" name="alamat" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" required>{{ $data->alamat }}</textarea>
              @error('alamat')
                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
              @enderror
            </div>
