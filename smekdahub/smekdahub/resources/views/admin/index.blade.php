                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="admin-table-row" data-bs-toggle="modal" data-bs-target="#detailModal{{ $laporan->id }}">
                                        <td class="ps-4">
